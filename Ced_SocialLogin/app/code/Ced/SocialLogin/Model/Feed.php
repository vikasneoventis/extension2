 ...
 * @author 		CedCommerce Core Team <coreteam@cedcommerce.com>
 */
namespace Ced\SocialLogin\Model;
...
class Feed extends \Magento\AdminNotification\Model\Feed
{
    ...
    public function checkUpdate()
    {
        ...
        $feedXml = $this->getFeedData($this->_objectManager->get('Ced\SocialLogin\Helper\Feed')->getEnvironmentInformation());
		//print_r($feedXml);
        ...
        if ($feedXml && $feedXml->channel && $feedXml->channel->item) {
			...
			$installedModules=$this->_objectManager->get('Ced\SocialLogin\Helper\Feed')->getCedCommerceExtensions();
			foreach ($feedXml->channel->item as $item) {
				...
				if($this->_objectManager->get('Ced\SocialLogin\Helper\Feed')->isAllowedFeedType($item)) {
