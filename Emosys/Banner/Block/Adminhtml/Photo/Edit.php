 ...
 */
namespace Emosys\Banner\Block\Adminhtml\Photo;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('emosys_banner_photo')->getId()) {
            return __("Edit Photo '%1'", $this->escapeHtml($this->_coreRegistry->registry('emosys_banner_photo')->getTitle()));
        } else {
            return __('New Photo');
        }
    }
