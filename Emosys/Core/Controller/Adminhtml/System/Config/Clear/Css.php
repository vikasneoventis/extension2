...
class Css extends \Magento\Backend\App\Action
{
    /**
     * @var JsonFactory
     */
    ...
    public function execute()
    {
        ...
        $command = "find {$root}pub/static/frontend/Emosys/. -type f -name '*.css' -delete";
        $result[] = $this->_execute($command);

        $command = "find {$root}pub/static/frontend/Emosys/. -type f -name '*.less' -delete";
        $result[] = $this->_execute($command);
        ...
        */
        ...
        $command = "find pub/static/frontend/Emosys/. -type f -name '*.css' -delete";
        $result[] = $this->_execute($command);

        $command = "find pub/static/frontend/Emosys/. -type f -name '*.less' -delete";
        $result[] = $this->_execute($command);
