...
class ClearCss extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
     * Command Field Name
     *
     ...
     * @var string
     */
    protected $_execButtonLabel = 'Clear CSS Cache';
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('system/config/clear_css.phtml');
        }
        return $this;
    }
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $this->addData(
            [
                ...
                'ajax_url' => $this->_urlBuilder->getUrl('emosys_core/system_config/clear_css'),
            ]
        );
